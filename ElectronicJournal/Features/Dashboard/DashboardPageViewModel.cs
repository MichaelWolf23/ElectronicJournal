    ...
    private void LoadActions()
    {
        switch (_currentUser.RoleName)
        {
            ...
            case "Администратор":
                ...
                AddAction("Открыть студентов", "Добавить или исправить данные студента.", "Студенты");
                AddAction("Открыть группы", "Создать группу или изменить курс.", "Группы");
        ...
        UserRepository userRepository)
    {
        ...
        switch (_currentUser.RoleName)
        {
            ...
            case "Администратор":
                ...
                AddPriority("Студент", "Исправить группу, контакты или статус.", "Данные", "success", "Студенты");
                AddPriority("Группа", "Добавить группу или изменить курс обучения.", "Курсы", "accent", "Группы");
                ...
                AddAttention("Студенты", $"{studentRepository.GetStudents().Count} карточек студентов.", "Проверить", "success", "Студенты");
                break;
